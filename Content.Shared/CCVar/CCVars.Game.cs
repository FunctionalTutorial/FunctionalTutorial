...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string>
        GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "TutorialServer", CVar.ARCHIVE); //Tutorial
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyFallbackPreset = CVarDef.Create("game.fallbackpreset", "TutorialServer", CVar.ARCHIVE); //Tutorial
